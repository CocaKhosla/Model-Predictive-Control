% MATLAB program for Linear MPC: Reducing online computation (Part 1) 
% Here we have taken all the constraints and made our new equation by
% reducing the state variable.
clear all;
close all
...
FX=blkdiag(FX,Fx);
gX=[gX;gx];
H=BU'*QX*BU+RU; %Our Final Quadratic Equation
